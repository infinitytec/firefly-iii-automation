...
sudo apt install apache2 mysql-common mariadb-server php8.3 php8.3-common php8.3-bcmath php8.3-intl php8.3-curl php8.3-zip php8.3-gd php8.3-xml php8.3-mbstring php8.3-ldap php8.3-mysql php-mysql php8.3-intl php8.3-xml php-cli curl -y
...
echo
sudo composer create-project grumpydictator/firefly-iii --no-dev --prefer-dist firefly-iii 6.1.1
...
sudo composer create-project firefly-iii/data-importer --no-dev --prefer-dist data-importer 1.4.0
